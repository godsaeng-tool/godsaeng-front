...
function Sidebar({
  ...
  const onSummaryClick = (summary, index) => {
    setActiveIndex(index);
    navigate(`/summary?filename=${encodeURIComponent(summary)}`);
  };
                  ...
                  localSummaries.map((summary, index) => (
                    ...
                    >
                      <div className="summary-item">
                        <span
                          onClick={() => onSummaryClick(summary, index)}
                        ...
                        <HiOutlineDotsHorizontal
                          onClick={(e) => {
                            e.stopPropagation();
                            handleMoreOptionsClick(index);
                          }}
                          className="more-options-icon"
                        />
                      </div>

                      {isMoreOptionsOpen === index && (
